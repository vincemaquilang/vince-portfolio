...
function pagePilling(){
    $('#pagepiling').pagepiling({
        ...
        anchors: ['home', 'resume', 'services', 'portfolio','contact','footer'],
        menu: '#myMenu',
        direction: 'vertical',
        verticalCentered: true,
        navigation: {
            'position': 'right',
            'tooltips': ['HOME', 'RESUME', 'SERVICES', 'PORTFOLIO', 'CONTACT', 'FOOTER']
        },
        loopBottom: true,
        loopTop: true,
        scrollingSpeed: 700,
...
function setProtectedEmail() {
    // Define email parts
    var user = "vichondriasmaquilang";
    var domain = "gmail.com";
    
    // Assemble the email address
    var email = user + "@" + domain;
    
    // Use jQuery to set the href attribute and the email
    $('.emailLink').attr('href', 'mailto:' + email);
  }

function calculateAge(){
    // Your birth date
    var birthDate = new Date('1998-10-28');
